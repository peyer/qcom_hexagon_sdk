...
typedef struct config_from_client_t{
    ...
    int                         id; /**< If DUAL IFE mode, identifies the streamer that this App instance is associated with.
                                     Can take values in [0;MAX_NUM_STREAMER]*/
    tapping_point_select_t      tapping_point; /**< Tapping point within the IFE pipeline */
    ife_frame_info_t            frame_info;
	unsigned long				ife_clk_freq; // for input streamer clock 
}config_from_client_t;
...
/// fp_cfgdata_get
///
/// @brief  Obtain configuration data for .
///
/// @param client_p: client handle.
///
/// @param id: identifier for the App instance (associated with a single streamer).
///
/// @param config_data_p: resulting configuration data.
///
/// @return: evt_return_type_t.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef int (*fp_cfgdata_get)(void *client_p, int id, config_data_t *config_data_p);
...
typedef struct framework_callbac_functns {
    ...
    fp_cfgdata_get              cfgdata_get;            /*The App will call this to obtain info about a different App instance */
