#ifndef _DSP_STREAMER_H
#define _DSP_STREAMER_H
///
#include "AEEStdDef.h"
#include "remote.h"
...
typedef struct dsp_streamer_buf_desc_t dsp_streamer_buf_desc_t;
struct dsp_streamer_buf_desc_t {
   int hndl;
   unsigned int offset;
   unsigned int len;
   uint64 vaddr;
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(dsp_streamer_buf_send_empty)(remote_handle64 _h, int* session_id, int buf, uint32 bufOffset, uint32 bufLen, int blocking) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(dsp_streamer_buf_recv_full)(remote_handle64 _h, int* session_id, dsp_streamer_buf_desc_t* buf_p, int blocking) __QAIC_HEADER_ATTRIBUTE;
