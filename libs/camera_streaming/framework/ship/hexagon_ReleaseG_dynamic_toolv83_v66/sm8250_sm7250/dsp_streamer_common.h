...
typedef struct ife_frame_info_t{
    ...
    unsigned int   right_offset;    /**< Offset from right side of image for this streamer*/
    unsigned int   left_overlap;    /**< Overlap with "preceding" left image portion for this streamer*/
}ife_frame_info_t;
