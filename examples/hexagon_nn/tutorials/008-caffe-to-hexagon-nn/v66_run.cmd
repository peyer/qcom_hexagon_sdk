...
adb push %HEXAGON_NN%\hexagon_Release_dynamic_toolv83_v66\ship\libhexagon_nn_skel.so /vendor/lib/rfsa/adsp
adb push %HEXAGON_NN%\test\vgg_labels.txt /vendor/etc/
