...
#	libexample_name=HEXAGON_SDK_ROOT +EXAMPLE_PATH+example_name+'/'+variant+'/ship/lib'+example_name+'.so'
	...
	if not options.no_rebuild:
		print "---- Build qmath_sample example for both Android and Hexagon ----"
		...
		print "---- Skip rebuilding qmath_sample example for both Android and Hexagon ----"
	...
	print("---- Run qmath_sample Example on " +Flag[:4] +" ----")
