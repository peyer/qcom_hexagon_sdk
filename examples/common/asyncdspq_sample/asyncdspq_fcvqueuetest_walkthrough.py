...
#******************************************************************************
parser = argparse.ArgumentParser(prog='asyncdspq_fcvqueuetest_walkthrough.py', description=__doc__, formatter_class=RawTextHelpFormatter)
call_parser(parser)
...
def run_example():
	...
	EXAMPLE_PATH='/examples/common/asyncdspq_sample'
	...
	libexample_dsp_skel=HEXAGON_SDK_ROOT +EXAMPLE_PATH+'/'+hex_variant+'/ship/libfcvqueue_dsp_skel.so'
	...
	print("---- Run asyncdspq_fcvqueuetest Example on " +Flag[:4] +" ----")
