...
#******************************************************************************
parser = argparse.ArgumentParser(prog='asyncdspq_queueperf_walkthrough.py', description=__doc__, formatter_class=RawTextHelpFormatter)
call_parser(parser)
...
def run_example():
	...
	libexample_name_skel=HEXAGON_SDK_ROOT +EXAMPLE_PATH+'/'+hex_variant+'/ship/libqueuetest_skel.so'
	...
	print("---- Run asyncdspq_queueperf Example on " +Flag[:4] +" ----")
