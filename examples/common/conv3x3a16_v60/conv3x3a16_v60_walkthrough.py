...
#******************************************************************************
parser = argparse.ArgumentParser(prog='conv3x3a16_v60_walkthrough.py', description=__doc__, formatter_class=RawTextHelpFormatter)
call_parser(parser)
...
#	libexample_name=HEXAGON_SDK_ROOT +EXAMPLE_PATH+example_name+'/'+variant+'/ship/lib'+example_name+'.so'
	...
	if not options.no_rebuild:
		print "---- Build conv3x3a16_v60 example for both Android and Hexagon ----"
		...
		print "---- Skip rebuilding conv3x3a16_v60 example for both Android and Hexagon ----"	
	...
	print("---- Run conv3x316_v60 Example on " +Flag[:4] +" ----")
