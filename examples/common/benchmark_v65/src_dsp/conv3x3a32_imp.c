...
@brief
   implementation file for conv 3x3 filter RPC interface.

Copyright (c) 2015-2017, 2019 QUALCOMM Technologies Incorporated.
...
} conv3x3a32_callback_t;

/*===========================================================================
    LOCAL FUNCTION
===========================================================================*/
// multi-threading callback function
static void conv3x3a32_callback(
    void* data
)
{
    conv3x3a32_callback_t    *dptr = (conv3x3a32_callback_t*)data;
...
// only supporting HVX version in this example.
    ...
    *dspCyc = (int32)(endCycles - startCycles);
    /* FARF(HIGH,"conv3x3a32_v60 profiling over %d iterations: %d PCycles, %d microseconds. Observed clock rate %d MHz",
