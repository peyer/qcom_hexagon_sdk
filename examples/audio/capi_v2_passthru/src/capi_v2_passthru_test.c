             ...
             capi_v2_proplist_t* static_properties)
{
  void* h = 0;
  //int (*pfn)(void) = 0;
  const char* cpszmodname = "capi_v2_passthru.so";
  const char* cpszget_static_properties = "capi_v2_passthru_get_static_properties";
  const char* cpszinit = "capi_v2_passthru_init";
...
#ifdef ENABLE_COMMAND_LINE_PARAMS
  TRY(err, test_capi_v2_main(capi_v2_passthru_get_static_properties,
                             capi_v2_passthru_init,
                             init_set_properties,
                             static_properties,
                             input_args->input_filename,
                             input_args->output_filename,
