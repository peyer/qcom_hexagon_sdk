...
typedef struct media_fmt_v2_t
{
	capi_v2_data_format_header_t format_header;
	capi_v2_standard_data_format_v2_t std;
...
{
  void* h = 0;
  const char* cpszmodname = "capi_v2_gain_32ch.so";
  const char* cpszget_static_properties = "capi_v2_gain_32ch_get_static_properties";
  const char* cpszinit = "capi_v2_gain_32ch_init";
...
#ifdef ENABLE_COMMAND_LINE_PARAMS
  TRY(err, test_capi_v2_main(capi_v2_gain_32ch_get_static_properties,
                             capi_v2_gain_32ch_init,
                             init_set_properties,
                             static_properties,
                             input_args->input_filename,
                             input_args->output_filename,
...
int test_main_start(int argc, char* argv[])
{
  ...
  media_fmt_v2_t in_media_format;
  ...
  media_fmt_v2_t *mptr = &in_media_format;
  ...
  mptr->channel_type[0] = PCM_CHANNEL_L;
  mptr->channel_type[1] = PCM_CHANNEL_R;
  heap_id.heap_id = 0;
