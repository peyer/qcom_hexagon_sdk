...
int main(int argc, char **argv) {
  ...
  char *filename = (char *) malloc(100 * sizeof(char));
    ...
    printf("AppReported (HVX64B-mode): Image %dx%d - sobel(64B): %0.4f cycles/pixel\n", (int)width, (int)height, (float)cycles_hvx64/width/height);
    /* -----------------------------------------------------*/
    /*  Write image output to file                          */
    /* -----------------------------------------------------*/
    strcpy(filename, "sobel_hvx64_");
    ...
    printf("AppReported (HVX128B-mode): Image %dx%d - sobel(128B): %0.4f cycles/pixel\n", (int)width, (int)height, (float)cycles_hvx128/width/height);
    strcpy(filename, "sobel_hvx128_");
    strcat(filename, argv[4]);
