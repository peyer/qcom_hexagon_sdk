...
int main(int argc, char **argv) {
  ...
  char *filename = (char *) malloc(100 * sizeof(char));
    ...
    SIM_RELEASE_HVX;
    printf("AppReported (HVX64B-mode): Image %dx%d - conv3x3a32(64B): %0.4f cycles/pixel\n", (int)width, (int)height, (float)cycles_hvx64/width/height);

    /* -----------------------------------------------------*/
    /*  Write image output to file                          */
    /* -----------------------------------------------------*/
    strcpy(filename, "conv3x3a32_hvx64_");
    ...
    SIM_RELEASE_HVX;
    printf("AppReported (HVX128B-mode): Image %dx%d - conv3x3a32(128B): %0.4f cycles/pixel\n", (int)width, (int)height, (float)cycles_hvx128/width/height);

    /* -----------------------------------------------------*/
    /*  Write image output to file                          */
    /* -----------------------------------------------------*/
    strcpy(filename, "conv3x3a32_hvx128_");
    strcat(filename, argv[4]);
