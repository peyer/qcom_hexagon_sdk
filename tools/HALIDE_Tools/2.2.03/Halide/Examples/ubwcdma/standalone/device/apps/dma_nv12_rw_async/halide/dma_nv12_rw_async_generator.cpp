...
public:
    ...
    void generate() {
        ...
        input_y_copy
            ...
            .async()         //  Directive to enable ping pong function in DMA along with fold
        ...
        work_uv
            .async() // Directive to ensure ping pong function in DMA along with fold
            .store_in(MemoryType::LockedCache) // After Processing, put the output in a locked Cache
            .fold_storage(x, tile_width * 2)
...
HALIDE_REGISTER_GENERATOR(DmaPipeline, dma_nv12_rw_async_halide)
