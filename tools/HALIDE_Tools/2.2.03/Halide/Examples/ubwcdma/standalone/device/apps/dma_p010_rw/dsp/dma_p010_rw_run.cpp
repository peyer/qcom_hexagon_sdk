...
int dma_p010_rw_run(const unsigned char *input_buffer,
    ...
    (*avg_time) = benchmark(iterations, [&]() {
        result = dma_p010_rw_halide(&input_y, &input_uv, &output_y, &output_uv);
        if (result != 0) {
