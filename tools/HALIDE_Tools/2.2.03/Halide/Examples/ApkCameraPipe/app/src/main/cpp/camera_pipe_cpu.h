#ifndef HALIDE_____camera_pipe_cpu_h
#define HALIDE_____camera_pipe_cpu_h
#include <stdint.h>
...
int camera_pipe_cpu(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_matrix_3200_buffer, struct halide_buffer_t *_matrix_7000_buffer, float _color_temp, float _gamma, float _contrast, int32_t _blackLevel, int32_t _whiteLevel, struct halide_buffer_t *_curved_buffer) HALIDE_FUNCTION_ATTRS;
int camera_pipe_cpu_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *camera_pipe_cpu_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return camera_pipe_cpu_metadata;
}
#endif
