...
@echo hexagon-readelf -S %TARGET_DIR%\main.elf ^| findstr "text_sw"
hexagon-readelf -S %TARGET_DIR%\main.elf | findstr "text_sw"
@echo.
@echo The .compress section was re-ordered to put the cold sections at the end
@echo hexagon-readelf -s %TARGET_DIR%\main.elf ^| findstr "comp_"
hexagon-readelf -s %TARGET_DIR%\main.elf | findstr "comp_"
@echo.
